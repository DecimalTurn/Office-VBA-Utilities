...
Public Function GetCellValue(ByVal ws As Worksheet, ByVal row_ As Long, ByVal column_ As Long) As Variant
...
Public Function GetCellText(ByVal ws As Worksheet, ByVal row_ As Long, ByVal column_ As Long) As String
Attribute GetCellText.VB_Description = "Gets the text of a cell in a row or column at an index."
    GetCellText = GetCell(ws, row_, column_).Text
End Function
